...
public class AudioHub
{
    ...
    private GameObject _sourcesObj;

    private const string SOUNDS_ADDRESSABLE_LABEL = "Sound";
    ...
    private async UniTask<List<Sound>> LoadSoundsAsync()
    {
        var handle = Addressables.LoadAssetsAsync<Sound>(SOUNDS_ADDRESSABLE_LABEL, null);
    ...
    {
        AudioSource newSource = _sourcesObj.AddComponent<AudioSource>();
