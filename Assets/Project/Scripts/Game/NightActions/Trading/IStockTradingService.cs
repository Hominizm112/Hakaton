...
public class Stock : SampleActiv//одна акция в портфеле
{
   ...
   // public float OpenPrice { get; private set; } //меняются извне
    ...
    public Stock(StockConfig stockConfig,int initialCurrentValue,int initialQuantity)//<--int
        : base(initialCurrentValue, initialQuantity: initialQuantity)
    {
       
       // ClosePrice = initialCurrentValue;
        StockInfo = stockConfig;
        //GainLossDay = 0f;
        //GainLossPercentDay = 0f;
